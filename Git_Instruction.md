...
* Делаем форк (fork) интересующего нас репозитория. "Форкаем"
* Затем обращаемся к команде git clone для создания собственной версии данного репозитория на удаленном ресурсу GitHub
* Создаем новую ветку и вносим туда необходимые изменения
* Производим сохранения этих изменений с помощью коммита и функции add только в этой ветке
* Отправляем все зафиксированные изменения в свой аккаунт на GitHub функцией Push 
* Далее в окне GitHub появляется возможность отправить Pull Request. Последовательность Сompare changes - Created Pull Request - File Changes **Pull request**
